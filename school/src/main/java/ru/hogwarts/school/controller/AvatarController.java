...
public class AvatarController {
    ...
    public Avatar uploadAvatar(@PathVariable Long studentId, @RequestParam MultipartFile file) throws IOException {
    ...
    public ResponseEntity<byte[]> downloadAvatarFromDisk(@PathVariable Long studentId) throws IOException {
        Avatar avatar = avatarService.findByStudentId(studentId);
